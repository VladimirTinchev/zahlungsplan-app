...
miete, werbung, gastro = 0.0, 0.0, 0.0
...
if uploaded_files:
    ...
    if len(betraege) >= 2:
        ...
        gastro = betraege[2] if len(betraege) == 3 else 0.0

miete = st.number_input("Monatlich: Miete + Nebenkosten", value=miete or 0.0, format="%.2f")
werbung = st.number_input("Halbjährlich: Werbebeitrag", value=werbung or 0.0, format="%.2f")
gastro = st.number_input("Monatlich: Gastro (Fettabluft)", value=gastro or 0.0, format="%.2f")
